...
class Person(models.Model):
    """ Person = <Name, Email>.
        ...
        Used for populating the RSS with authors and owner data.
    """
...
class ProgramInfo(models.Model):
    ...
    from the podgen documentation:
        ...
        The URL of the artwork for this podcast. iTunes prefers square
        images that are at least 1400x1400 pixels.
        ...
        space (CMYK is not supported). The URL must end in ”.jpg” or ”.png”;
        if they don’t, a NotSupportedByItunesWarning will be issued.
